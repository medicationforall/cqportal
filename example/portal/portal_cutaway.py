...
bp_portal.bp_frame.window_cut_width = 6.5
...
result_open = bp_portal.build_cutaway()
cut_away = cq.Workplane("XY").box(100,170, 150)

# show_object(result_open.cut(cut_away.translate((-50,85,75))))
cq.exporters.export(result_open.cut(cut_away.translate((-50,85,75))), 'stl/portal_cutaway.stl')
